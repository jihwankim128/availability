...
const deploymentUnavailableResponse = new Counter('deployment_unavailable_response');
...
export const options = {
  ...
  thresholds: {
    ...
    deployment_unavailable_response: ['count==0'],
  },
};
...
export function sendContinuousRequests() {
  const response = http.get(`${baseUrl}/api/info`, {
    tags: {
      experiment: 'step-05-blue-green-deployment',
  ...
  deploymentUnavailableResponse.add(succeeded ? 0 : 1);
